...
function generatorGUIModule.createGeneratorFrame(main)
    ...
    local generatorButtom = frame:addButton():setText("Generator is"):setPosition(pageTitleX, 8):onClick(handleGeneratorButtom):setBackground(colors.red):setBorder(colors.white)
